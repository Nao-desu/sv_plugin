...
description = {
    0:{
        0:"其《全能》知曉絕對，沐浴於傲慢。  \r  那「愚蠢」即為必然性。  \r  與「無聊」所支配的她一起。  \r  將「已知」的一切化為灰色。",
        1:"其《無知》的特權是，能獲得智慧。  \r  那「純真」即為可能性。  \r  去「挑戰」吧，與她一起。  \r  而「未知」的財寶就在盡頭等待。"
    },
    1:{
        0:"──其名為《魔術師》，所示為《創造》。  \r  自思考產生想像，從想像誕生構築。  \r  滿懷自信做出的作品，才會蘊藏令人著迷的力量。",
        1:"──其為魔導的使役者，將思想形意具現的存在。  \r  他的原動力是無邊無際、永不厭煩的上進心。  \r  滿溢的自信不懂何謂碰壁，就只是持續不斷地創造。"
    },
    2:{
        0:"──其為《女祭司》，所示為《聰穎》。  \r  她毫不動搖，看清這千變萬化的人世。  \r  在何時何地的判斷，皆為千思萬慮後所做出的選擇。",
        1:"──其為聖職者，向人們宣揚啟示的存在。  \r  遵從自己的決定，為迷途眾生展現其信仰。  \r  她所帶來的救贖，無疑是不贅的正確之事。"
    },
    3:{
        0:"──其名為《女帝》，所示為《母性》。  \r  崇敬著憐愛、養育以及守護。  \r  在慈愛中被養育的孩子們，將化為包覆敵意之盾。",
        1:"──其為孕育者，以慈愛懷抱一切的存在。  \r  她對名為戰場的搖籃，傾注滿懷母性的眼神。  \r  真正嚴峻的環境，才能養育出真正健壯的孩子。"
    },
    4:{
        0:"──其名為《皇帝》，所示為《權威》。  \r  土塊即為僕臣，是忠實的使魔。以威嚴統率之。  \r  伸手一指，便可築起一個魔導的王國。",
        1:"──其為支配者，以魔力統治一切的存在。  \r  魔導具、詠唱皆為其僕人，皆能輕易地差遣與掌控。  \r  集所有魔導之力於一身，化為成就霸業之基石。"
    },
    5:{
        0:"──其為《教皇》，所示為《慈悲》。  \r  打開其內心門扉的鑰匙，僅有體諒。  \r  奔向他身旁的，正是開啟門扉之人。",
        1:"──其為指導者，佇立於神聖領域的存在。  \r  對違反法律者降下制裁。  \r  但他並未遺忘溫柔，同樣給予被制裁者再起的機會。"
    },
    6:{
        0:"很渴望「比翼」的關係呢，屬於我的你。  \r  賜予你「機緣」吧。我是《戀人》，掌管《相愛》。  \r  若興起「風情」便無法分離，你將受那思慕吸引。  \r  展現那「愛執」吧。你將會遠離孤獨的未來。",
        1:"想成為「連理」的共犯呢，屬於我的你。  \r  聯繫起「奇遇」吧。我是《戀人》，掌管《誘惑》。  \r  就算離「月意」而去，多少新伴侶我都能幫你找來。  \r  展現那「染著」吧。你渴望什麼顏色的愛呢？"
    },
    7:{
        0:"汝為受載運的負荷，而「吾為」牽引的悍馬！  \r  吾正是《戰車》！掌管「汝之」《直行》！  \r  現在，戰場即為筆直之霸道！以「武器」裝飾之道！  \r  那麼，向前進吧！將「不屬實」之榮耀化為現實！",
        1:"《暴走》為純粹的疾馳。  \r  汝僅須遠觀那結局。  \r  吾為汝之武器，不屬實。  \r  汝才是，吾之武器。"
    },
    8:{
        0:"請聽這個代替打招呼的咆哮！準備，嘎喔～！  \r  呵呵。怎麼樣呀？人家是《力量》，掌管《活力》！  \r  想變強、想要力量！我就是被那種願望召喚來的！  \r  來，讓我幫你引導出那潛藏在你體內的勇氣！",
        1:"毫。  \r  無。  \r  《力量》。"
    },
    9:{
        0:"──其名為《隱者》，所示為《熟慮》。  \r  慎重、冷靜且沉著，給予煩惱者建言。  \r  深思後所告知他人的建言，簡單而有效。",
        1:"──其為沉思者，潛藏於草木之蔭的存在。  \r  大樹、林蔭以及森林裡的所有一切，皆為其草堂。  \r  他神出鬼沒，是位躲藏隱匿並遠離紛爭的哲人。"
    },
    10:{
        0:"……試看看吧。請問呀，主人啊主人。  \r  我是《命運之輪》，掌管《幸運》，  \r  可以帶給主人您美好又驚異的體驗。  \r  也就是說，告訴我您的願望……",
        1:"……試試，您看。變成這樣了，主人啊主人。  \r  我掌管《不幸》，也就是能將災難轉嫁給他人。  \r  快看快看，好悲慘！托它的福，幸運跑來這裡了。  \r  這也是主人的幸福對吧？那不然，換個願望……"
    },
    11:{
        0:"吾之友人啊，聆聽那聲吶喊吧。  \r  我是《正義》，掌管《平等》。  \r  自狹小的牢籠解放至藍天之際。  \r  一視同仁的律法在此展翅高飛。",
        1:"吾之友人啊，聽進那絲細語吧。  \r  我是《正義》，掌管《不公》。  \r  既是清白之法，亦是彈劾之劍。  \r  必須將所有邪惡之人斬草除根。"
    },
    12:{
        0:"《自我犧牲》這種事情，一點意義都沒有！  \r  ……你應該不會相信這種話吧？  \r  我是《倒吊人》！掌管《自我犧牲》！  \r  顛倒，欺騙，完全相反！",
        1:"顛倒，欺騙，完全相反！  \r  什麼是真實，什麼是謊言，都是由自己決定！  \r  ……被這樣講的時候可別相信喔？你要連我也懷疑！  \r  世間一切都不過是瑣事！有你的《自我滿足》就好！"
    },
    13:{
        0:"──其名為《死神》，所示為《轉變》。  \r  以生的不確定性來克服死的苦難。  \r  命運的潛移，默化來自四面八方的阻礙。",
        1:"──其為搬運者，降下不可避死亡的存在。  \r  死亡不分外表、不論貴賤，不會放過任何生命。  \r  那馬蹄會造訪一切眾生，一視同仁地使之化為蒼白。"
    },
    14:{
        0:"連真理也毫無用處。現在，你的世界已被翻新。  \r  我正是《節制》，掌管《節儉》。  \r  因為有所必要而追求，  \r  真。",
        1:"請用你的眼觀察，這滿溢無用與無謂的世界。  \r  有其必要的是心臟鼓動、活著。  \r  愛、憤怒及悲傷皆是，  \r  無。"
    },
    15:{
        0:"──其為《惡魔》，所示為《暴力》。  \r  私慾，刺激。不論理由如何，皆肯定暴虐之存在。  \r  伴隨著苦痛，帶來痛楚，奪去其追求之物。",
        1:"──其為災厄，欲求不止且狂暴的存在。  \r  那對翅膀及其僕從，皆為在肆虐後所奪取之物。  \r  以自己的苦痛為由，不斷給予他人痛楚。"
    },
    16:{
        0:"──其為《塔》，所示為《崩壞》。  \r  他所前行之處災害四起，慘劇之雷將性命一分為二。  \r  若將恐懼埋於瓦礫之中，至少能洗刷這屈辱吧。",
        1:"──其為破壞者，訕笑並高展龍翼的存在。  \r  將赤紅雷電環繞於身，散播著毀壞及慘劇。  \r  愉悅與快感，使龍人為了折磨他人而揮舞利爪。"
    },
    17:{
        0:"──其名為《星》，所示為《希望》。  \r  她賜予懷抱願望的開拓者無數的光芒。  \r  而散落在虛空的無數星光，將化為點亮希望的燈火。",
        1:"──其為虛空之主，俯瞰著大地運行的存在。  \r  她掌管星之光芒，自天上照耀而不出手援助。  \r  僅微笑著遠望那受其光芒所輝映之人。"
    },
    18:{
        0:"──其為《月亮》，所示為《不安》。  \r  現身於懼怕的人身旁，將自己的身軀用於防備。  \r  即便她年幼且尚未成熟，仍是隻吞噬膽怯的野獸。",
        1:"──其為防備者，將恐懼踐踏在地的存在。  \r  雖然幼小卻勇敢的她，於月光下兇猛地咆哮。  \r  在認定的主人面前，狼人即是獨一無二的守衛。"
    },
    19:{
        0:"──其名為《太陽》，所示為《成就》。  \r  升起的太陽毫無困惑，化為滿溢活力之日輪。  \r  光燦的太陽連陰影處亦會照耀，  \r  沒有事物會無為而逝。",
        1:"──其為喚來豐收者，成就出顯赫發展的存在。  \r  龍尾若歡喜地擺動，吉兆之日便會升起。  \r  沐浴於龍之聖光者，將獲得幸福氣息的吹拂。"
    },
    20:{
        0:"──其為《審判》，所示為《復活》。  \r  修正狀態，孤獨地調整。小動物們隨心所欲地玩耍。  \r  雖然那裡沒有任何人的助力，  \r  但是總有一天也夠修復破損。",
        1:"──其為調律者。將一切恢復原狀的存在。  \r  等待救援實在無聊。靜待時機也相當無趣。  \r  能借助的幫手不存在任何一處，  \r  只能靠自己來傳達。"
    },
    21:{
        0:"吾之《世界》為掌。  \r  管理《完成》，汝，以及無法逃離之創世。",
        1:"終結即《未完》，創世之預兆。  \r  一切皆在《世界》的掌握之中。"
    }
}
